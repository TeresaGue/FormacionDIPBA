 ...
 */
final class Version20220915111533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE municipios (id INT AUTO_INCREMENT NOT NULL, provincias_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, INDEX IDX_BBFAB586A156727D (provincias_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE municipios ADD CONSTRAINT FK_BBFAB586A156727D FOREIGN KEY (provincias_id) REFERENCES provincias (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE municipios DROP FOREIGN KEY FK_BBFAB586A156727D');
