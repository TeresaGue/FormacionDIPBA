 ...
 */
final class Version20220915082939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE itinerario_formativos (id INT AUTO_INCREMENT NOT NULL, criteriosseleccion_id INT NOT NULL, modulospropios_id INT NOT NULL, certificados_profesionalidad_id INT NOT NULL, denominacion VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_EC5A64DA20A488EC (criteriosseleccion_id), INDEX IDX_EC5A64DA9721733 (modulospropios_id), INDEX IDX_EC5A64DA240AA6C5 (certificados_profesionalidad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
