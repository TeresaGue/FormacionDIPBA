...
/**
 * @extends ServiceEntityRepository<SituacionLaboral>
 *
...
class SituacionLaboralRepository extends ServiceEntityRepository
{
    ...
    public function add(SituacionLaboral $entity, bool $flush = false): void
    {
    ...
    public function remove(SituacionLaboral $entity, bool $flush = false): void
    {
